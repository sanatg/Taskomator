...
class AboutDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        logo = QLabel()
        logo.setPixmap(QPixmap(os.path.join('images', 'ghost2.png')))
        layout.addWidget(logo)
        layout.addWidget(QLabel("Privacy made easy"))
        layout.addWidget(QLabel("Version 0.1"))
        layout.addWidget(QLabel("Ghost is a Privacy browser which does'nt tracks you and saves you from tracking and also connects you to the onion routing circuit"))
        layout.addWidget(QLabel("Copyright @Sanat Gupta"))
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action = QAction(QIcon(os.path.join('images', 'question.png')), "About Ghost", self)
        about_action.setStatusTip("Find out more about Ghost")  # Hungry!
        about_action.triggered.connect(self.about)
        help_menu.addAction(about_action)

        navigate_mozarella_action = QAction(QIcon(os.path.join('images', 'lifebuoy.png')),
                                            "Ghost Homepage", self)
        navigate_mozarella_action.setStatusTip("Go to Ghost homepage")
        ...
        self.setWindowIcon(QIcon(os.path.join('images', 'ghost.png')))
    ...
    def update_title(self, browser):
        ...
        self.setWindowTitle("%s - Ghost" % title)

    def navigate_mozarella(self):
        self.tabs.currentWidget().setUrl(QUrl("https://github.com/sanatg"))
